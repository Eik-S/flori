...
export function Waves() {
  return (
    <Fragment>
      <img src="/images/welle4.svg" alt="" css={styles.wave(1)} />
      <img src="/images/welle3.svg" alt="" css={styles.wave(2)} />
      <img src="/images/welle2.svg" alt="" css={styles.wave(3)} />
      <img src="/images/welle1.svg" alt="" css={styles.wave(4)} />
    </Fragment>
  )
}
